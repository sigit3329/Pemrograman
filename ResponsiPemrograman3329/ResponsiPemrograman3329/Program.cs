...
namespace ResponsiPemrograman2836
{
    class Program
    {
        ...
        {
            Karyawan karyawan = new Karyawan(20113329, "Sigit  N", 3000000);
            Karyawan karyawan2 = new Karyawan(20113329, "Nugroho", 2000000);
            ...
            Console.WriteLine("");
            Console.WriteLine("Alhamdulillah dapet kenaikan gaji 10%!!");
            Console.WriteLine("");
